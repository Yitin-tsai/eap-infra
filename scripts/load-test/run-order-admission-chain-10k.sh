...
ORDER_ADMISSION_WALLET_OUTBOX_BATCH_CONFIRM_ENABLED="${ORDER_ADMISSION_WALLET_OUTBOX_BATCH_CONFIRM_ENABLED:-false}"
...
if [[ "${START_SERVICES}" == "true" ]]; then
  ...
  EAP_MATCH_USER_OPEN_ORDER_INDEX_ENABLED="${ORDER_ADMISSION_MATCH_USER_OPEN_ORDER_INDEX_ENABLED}" \
    ...
    EAP_WALLET_OUTBOX_BATCH_CONFIRM_ENABLED="${ORDER_ADMISSION_WALLET_OUTBOX_BATCH_CONFIRM_ENABLED}" \

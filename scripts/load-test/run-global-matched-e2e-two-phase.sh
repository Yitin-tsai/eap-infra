...
run_status=0
set +e
MARKET_ID="${MARKET_ID}" EVENTS="${EVENTS}" PUBLISHERS="${PUBLISHERS}" PUBLISHER_CONNECTION_CACHE_SIZE="${PUBLISHER_CONNECTION_CACHE_SIZE}" PUBLISHER_MAX_IN_FLIGHT="${PUBLISHER_MAX_IN_FLIGHT}" PUBLISHER_CONFIRM_TIMEOUT_MS="${PUBLISHER_CONFIRM_TIMEOUT_MS}" TIMEOUT_SECONDS="${TIMEOUT_SECONDS}" TARGET_TPS="${TARGET_TPS}" DURATION_SECONDS="${DURATION_SECONDS}" MIN_OFFERED_LOAD_RATIO="${MIN_OFFERED_LOAD_RATIO}" PHASE=run \

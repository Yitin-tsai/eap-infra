...
| Failure recovery control plane | [`failure-recovery-control-plane.zh-TW.md`](failure-recovery-control-plane.zh-TW.md) / [`ADR-005`](adr/ADR-005-failure-recovery-control-plane.zh-TW.md) | Protected single-case inspection, dry-run, replay policy, DLQ quarantine, action idempotency, rate limit, and audit boundary |

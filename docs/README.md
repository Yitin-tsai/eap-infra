...
| Durable-debt SLO | [`durable-debt-slo.zh-TW.md`](durable-debt-slo.zh-TW.md) | Versioned service-owned debt contract, metrics, alerts, schema-v4 completion gate, query cost, and remaining recovery limits |
| Order Saga timeout detector | [`order-saga-timeout-detector.zh-TW.md`](order-saga-timeout-detector.zh-TW.md) | Warning-only lifecycle timeout semantics, effective-state authority, bounded diagnostics, alerts, and safety boundary |
| Failure recovery control plane | [`failure-recovery-control-plane.zh-TW.md`](failure-recovery-control-plane.zh-TW.md) / [`ADR-005`](adr/ADR-005-failure-recovery-control-plane.zh-TW.md) / [`ADR-006`](adr/ADR-006-owner-aware-shared-dlq-replay.zh-TW.md) | Protected single-case inspection, owner-side recovery, conditional Wallet／Order trade DLQ replay, action idempotency, rate limit, audit boundary, and confirm→audit crash evidence |
...
| Order reliability design record | [`features/order-asset-reservation-result-reliability.zh-TW.md`](features/order-asset-reservation-result-reliability.zh-TW.md) | Original reservation-result inbox scope; later intake-outage and timeout work is linked from current documents |
| Wallet reliability design record | [`features/wallet-reservation-reliability-and-saga-recovery.zh-TW.md`](features/wallet-reservation-reliability-and-saga-recovery.zh-TW.md) | Original Wallet inbox and retry plan; current status is tracked by the backlog and latest-version guide |
...
| Latest full-chain campaign | [`benchmarks/2026-09-04-current-reliability-full-chain.md`](benchmarks/2026-09-04-current-reliability-full-chain.md) | Current Wallet／Match inbox path: strict 200 diagnostic pass, three-service inbox age/debt, final outbox/cleanup checks, and claim limits |
